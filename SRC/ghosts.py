...
Fred_img = pygame.transform.scale(pygame.image.load('SRC/assets/Fred.png'), (45,45))
Emily_img = pygame.transform.scale(pygame.image.load('SRC/assets/Emily.png'), (45,45))
Jessie_img = pygame.transform.scale(pygame.image.load('SRC/assets/Jessie.png'), (45,45))
Jordan_img = pygame.transform.scale(pygame.image.load('SRC/assets/Jordan.png'), (45,45))
Thanos_img = pygame.transform.scale(pygame.image.load('SRC/assets/thanos_ghost_animated.gif'), (45,45))
Powerup_ghost_img = pygame.transform.scale(pygame.image.load('SRC/assets/Powerup_ghost.png'), (45,45))
Dead_ghost_img = pygame.transform.scale(pygame.image.load('SRC/assets/Dead_ghost.png'), (45,45))
