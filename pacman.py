...
def draw_board():
    screen.fill("black")
    #obrazki ścian
    pozioma_sciana_png = pygame.image.load("Praktyki2023-1/SRC/assets/sciany_hell/sciana.png")
    pionowa_sciana_png = pygame.image.load("Praktyki2023-1/SRC/assets/sciany_hell/pionowa_sciana.png")
    skret_lewo_png = pygame.image.load("Praktyki2023-1/SRC/assets/sciany_hell/skret_lewo.png")
    skret_prawo_png = pygame.image.load("Praktyki2023-1/SRC/assets/sciany_hell/skret_prawo.png")
    potrojny_dol_png = pygame.image.load("Praktyki2023-1/SRC/assets/sciany_hell/potrojny_dol.png")
    potrojny_prawo_png = pygame.image.load("Praktyki2023-1/SRC/assets/sciany_hell/potrojny_prawo.png")
    potrojny_lewo_png = pygame.image.load("Praktyki2023-1/SRC/assets/sciany_hell/potrojny_lewo.png")
    potrojny_lewo_gora_png = pygame.image.load("Praktyki2023-1/SRC/assets/sciany_hell/potrojny_lewo_gora.png")
    potrojny_prawo_gora_png = pygame.image.load("Praktyki2023-1/SRC/assets/sciany_hell/potrojny_prawo_gora.png")
